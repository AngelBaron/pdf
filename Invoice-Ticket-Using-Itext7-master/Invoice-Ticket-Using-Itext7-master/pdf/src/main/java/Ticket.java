...
public class Ticket {
    ...
    public static void main(String[] args) throws FileNotFoundException, MalformedURLException {
        String path = "C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\MY-PDF.pdf";
    ...
    private static Table AddFareAndPaymentDetails(float[] fareAndPaymentDetailsWidth, String baseFare, String dealDiscount, String operatorGST, String total) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\rupee-icon.png")).scaleAbsolute(10,10))
        ...
        Paragraph p = new Paragraph();
        Image img = new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\rupee-icon.png")).scaleAbsolute(10,10);
        p.add("- ");
        p.add(img);
    ...
    private static Table AddtravellerDetails(float[] travellerDetailsWidth, String travellerName, String travellerGender, String travellerSeatNo) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\Circle-icon.png")).scaleAbsolute(10,10))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderBottom(Border.NO_BORDER)
    ...
    private static Table AddBoardingDetails1(float[] boardingDetailsWidth, String busOperatorName1,String busOperatorName2, String boardingPoint1,String boardingPoint2,  String droppingPoint1, String droppingPoint2) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\bus-icon.png")).scaleAbsolute(12,12))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderRight(Border.NO_BORDER)
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\location-icon.png")).scaleAbsolute(12,12))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderRight(Border.NO_BORDER)
    ...
    private static Table AddBoardingDetails2(float[] boardingDetails2Width, String reportingTime, String BoardingTime) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\clock-icon.png")).scaleAbsolute(12,12))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderRight(Border.NO_BORDER)
    ...
    private static Table AddBoardingDetails3(float[] boardingDetails1Width, String operatorContactNumber, String landmark) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\phoneIcon.png")).scaleAbsolute(15,15))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderRight(Border.NO_BORDER)
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\location-icon.png")).scaleAbsolute(15,15))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(15)
                .setBorderRight(Border.NO_BORDER)
    ...
    private static Table AddtoAndFromTable(float[]toAndFromTableWidth, String departurePlace, String departureTime, String departureDate, String arrivalPlace, String arrivalTime, String arrivalDate) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\bus.png")).scaleAbsolute(25f,25f))
    ...
    private static Table AddHeader(float[] headerWidth, String PhoneNumber) throws MalformedURLException {
        ...
        header.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\phoneIcon.png")).scaleAbsolute(20f,20f))
                .setTextAlignment(TextAlignment.RIGHT)
                .setBorderBottom(Border.NO_BORDER)
                .setBorderLeft(Border.NO_BORDER)
                .setBorderRight(Border.NO_BORDER)
    ...
    private static Table AddHeadder(String Heading, boolean WantMarginInTheBeginning) throws MalformedURLException {
        ...
        table.addCell(new Cell().add(new Image(ImageDataFactory.create("C:\\Users\\lucho\\Downloads\\Invoice-Ticket-Using-Itext7-master\\Invoice-Ticket-Using-Itext7-master\\pdf\\src\\main\\java\\Circle-icon.png")).scaleAbsolute(15,15))
                .setTextAlignment(TextAlignment.RIGHT)
                .setVerticalAlignment(VerticalAlignment.MIDDLE)
                .setPaddingLeft(30)
                .setBorderRight(Border.NO_BORDER)
